# Terminal Output Clinic

Terminal Output Clinic is a Codex Labkit plugin for summarizing command output into errors and next actions. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for summarizing command output into errors and next actions, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `terminal-output-clinic` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with summarizing command output into errors and next actions.
