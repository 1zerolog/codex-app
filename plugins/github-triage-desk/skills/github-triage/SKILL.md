---
name: github-triage
description: Use when Codex needs help with triaging issues, PRs, checks, labels, and review state.
---

# GitHub Triage Desk Skill

## Purpose

Use this skill when Codex needs to handle triaging issues, PRs, checks, labels, and review state. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce a GitHub triage summary.
