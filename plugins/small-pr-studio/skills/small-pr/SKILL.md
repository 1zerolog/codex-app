---
name: small-pr
description: Use when Codex needs help with splitting large work into reviewable PR slices.
---

# Small PR Studio Skill

## Purpose

Use this skill when Codex needs to handle splitting large work into reviewable PR slices. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
