---
name: task-planning
description: Use when Codex needs help with breaking broad requests into executable engineering tasks.
---

# Task Planning Desk Skill

## Purpose

Use this skill when Codex needs to handle breaking broad requests into executable engineering tasks. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce an implementation task plan.
