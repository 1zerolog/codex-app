---
name: cli-release
description: Use when Codex needs help with preparing CLI tools for release and smoke testing.
---

# CLI Release Workbench Skill

## Purpose

Use this skill when Codex needs to handle preparing CLI tools for release and smoke testing. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "argparse|click|commander|yargs|cobra|cli"
rg "version|help|usage"
```
...
Produce a CLI release checklist.
