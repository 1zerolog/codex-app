---
name: openapi
description: Use when Codex needs help with reviewing OpenAPI specs and generated-client readiness.
---

# OpenAPI Workbench Skill

## Purpose

Use this skill when Codex needs to handle reviewing OpenAPI specs and generated-client readiness. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
rg "operationId|components|responses|security"
```
...
Produce an OpenAPI spec review.
