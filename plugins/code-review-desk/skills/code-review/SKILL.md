---
name: code-review
description: Use when Codex needs help with reviewing changes for bugs, regressions, and missing tests.
---

# Code Review Desk Skill

## Purpose

Use this skill when Codex needs to handle reviewing changes for bugs, regressions, and missing tests. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
git diff --stat
git diff --check
rg "TODO|FIXME|throw|except|catch"
```
...
Produce a severity-ordered review.
