---
name: monorepo-control
description: Use when Codex needs help with navigating monorepos, package graphs, and affected tests.
---

# Monorepo Control Room Skill

## Purpose

Use this skill when Codex needs to handle navigating monorepos, package graphs, and affected tests. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg --files | rg "pnpm-workspace|turbo|nx|lerna|rush|package.json"
