...
Secret Sentinel is a Codex Labkit plugin for scanning diffs and repos for sensitive files and secrets. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for scanning diffs and repos for sensitive files and secrets, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `secret` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with scanning diffs and repos for sensitive files and secrets.
