...
description: Use when Codex needs help with mapping repository structure before complex work.
---

# Repo Cartography Studio Skill

## Purpose

Use this skill when Codex needs to handle mapping repository structure before complex work. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```markdown
## Repo Cartography Studio Result
