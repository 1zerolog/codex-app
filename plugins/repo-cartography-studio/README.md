# Repo Cartography Studio

Repo Cartography Studio is a Codex Labkit plugin for mapping repository structure before complex work. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for mapping repository structure before complex work, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `repo-cartography` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with mapping repository structure before complex work.
