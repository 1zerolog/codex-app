---
name: type-safety
description: Use when Codex needs help with improving type safety at important boundaries.
---

# Type Safety Studio Skill

## Purpose

Use this skill when Codex needs to handle improving type safety at important boundaries. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "any|type: ignore|@ts-ignore|unknown|dict\[|Record<"
rg "interface|type |TypedDict|dataclass"
```
