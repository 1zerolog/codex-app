...
Local Dev Medic is a Codex Labkit plugin for fixing local development setup and first-run failures. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for fixing local development setup and first-run failures, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `local-dev-medic` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with fixing local development setup and first-run failures.
