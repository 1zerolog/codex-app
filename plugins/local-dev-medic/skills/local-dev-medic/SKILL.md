---
name: local-dev-medic
description: Use when Codex needs help with fixing local development setup and first-run failures.
---

# Local Dev Medic Skill

## Purpose

Use this skill when Codex needs to handle fixing local development setup and first-run failures. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce a local setup diagnosis.
