...
Test Fixture Factory is a Codex Labkit plugin for designing reusable fixtures for tests and local reproduction. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for designing reusable fixtures for tests and local reproduction, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `test-fixture-factory` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with designing reusable fixtures for tests and local reproduction.
