...
description: Use when Codex needs help with designing reusable fixtures for tests and local reproduction.
---

# Test Fixture Factory Skill

## Purpose

Use this skill when Codex needs to handle designing reusable fixtures for tests and local reproduction. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg --files | rg "fixture|mock|testdata|factory"
rg "beforeEach|pytest.fixture|mock|stub"
```
