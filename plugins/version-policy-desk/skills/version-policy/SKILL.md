---
name: version-policy
description: Use when Codex needs help with defining versioning, deprecation, and compatibility rules.
---

# Version Policy Desk Skill

## Purpose

Use this skill when Codex needs to handle defining versioning, deprecation, and compatibility rules. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "version|semver|deprecat|breaking|changelog"
git tag --list
```
