...
description: Use when Codex needs help with turning repeated operations into runbooks.
---

# Workflow Runbook Forge Skill

## Purpose

Use this skill when Codex needs to handle turning repeated operations into runbooks. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "runbook|deploy|release|backup|restore" docs README.md .github
git status --short
```
