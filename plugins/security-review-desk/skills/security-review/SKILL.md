...
description: Use when Codex needs help with reviewing inputs, auth, permissions, and data exposure.
---

# Security Review Desk Skill

## Purpose

Use this skill when Codex needs to handle reviewing inputs, auth, permissions, and data exposure. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
