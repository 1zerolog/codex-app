...
description: Use when Codex needs help with capturing important technical decisions as ADR-style notes.
---
...
Use this skill when Codex needs to handle capturing important technical decisions as ADR-style notes. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
rg "ADR|decision|architecture" docs README.md
```
...
```markdown
## Architecture Decision Log Result
