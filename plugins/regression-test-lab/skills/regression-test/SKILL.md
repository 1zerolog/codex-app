...
description: Use when Codex needs help with designing regression tests for bugs and risky changes.
---

# Regression Test Lab Skill

## Purpose

Use this skill when Codex needs to handle designing regression tests for bugs and risky changes. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce targeted regression tests.
