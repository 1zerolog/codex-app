---
name: sql-review
description: Use when Codex needs help with reviewing SQL correctness, performance, and safety.
---

# SQL Review Bench Skill

## Purpose

Use this skill when Codex needs to handle reviewing SQL correctness, performance, and safety. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "select |insert |update |delete |join |where" -i
rg "execute|query|raw|prepare"
```
