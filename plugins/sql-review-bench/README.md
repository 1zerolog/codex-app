...
SQL Review Bench is a Codex Labkit plugin for reviewing SQL correctness, performance, and safety. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for reviewing SQL correctness, performance, and safety, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `sql-review` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with reviewing SQL correctness, performance, and safety.
