---
name: bug-bash-planner
description: Use when Codex needs help with planning focused bug bash sessions and verification passes.
---

# Bug Bash Planner Skill

## Purpose

Use this skill when Codex needs to handle planning focused bug bash sessions and verification passes. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
