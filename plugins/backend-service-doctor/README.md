# Backend Service Doctor

Backend Service Doctor is a Codex Labkit plugin for diagnosing backend service behavior, failures, and boundaries. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for diagnosing backend service behavior, failures, and boundaries, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `backend-service-doctor` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with diagnosing backend service behavior, failures, and boundaries.
