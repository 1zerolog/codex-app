---
name: commit-craft
description: Use when Codex needs help with grouping repository changes into clean reviewable commits.
---
...
Use this skill when Codex needs to handle grouping repository changes into clean reviewable commits. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce a clean commit plan or commit series.
