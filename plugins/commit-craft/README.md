...
Commit Craft is a Codex Labkit plugin for grouping repository changes into clean reviewable commits. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for grouping repository changes into clean reviewable commits, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `commit-craft` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with grouping repository changes into clean reviewable commits.
