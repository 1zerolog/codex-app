---
name: ux-copy
description: Use when Codex needs help with improving UI labels, errors, and empty states.
---
...
Use this skill when Codex needs to handle improving UI labels, errors, and empty states. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "Error|Submit|Cancel|Loading|Empty|Success|Failed"
rg "placeholder|label|aria-label|title"
```
