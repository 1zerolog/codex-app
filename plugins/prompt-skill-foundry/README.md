# Prompt Skill Foundry

Prompt Skill Foundry is a Codex Labkit plugin for turning repeated prompts into reusable Codex skills. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for turning repeated prompts into reusable Codex skills, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `prompt-skill-foundry` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with turning repeated prompts into reusable Codex skills.
