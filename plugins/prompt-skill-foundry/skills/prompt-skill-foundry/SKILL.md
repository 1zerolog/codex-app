---
name: prompt-skill-foundry
description: Use when Codex needs help with turning repeated prompts into reusable Codex skills.
---

# Prompt Skill Foundry Skill

## Purpose

Use this skill when Codex needs to handle turning repeated prompts into reusable Codex skills. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
find skills templates docs -maxdepth 3 -type f
...
Produce a reusable skill draft.
