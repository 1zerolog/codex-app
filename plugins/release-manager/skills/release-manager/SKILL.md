...
description: Use when Codex needs help with coordinating release readiness, notes, and rollback.
---
...
Use this skill when Codex needs to handle coordinating release readiness, notes, and rollback. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
