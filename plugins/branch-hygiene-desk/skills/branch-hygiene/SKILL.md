---
name: branch-hygiene
description: Use when Codex needs help with keeping branches, remotes, and working trees clean.
---

# Branch Hygiene Desk Skill

## Purpose

Use this skill when Codex needs to handle keeping branches, remotes, and working trees clean. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
Produce a branch hygiene report.
