...
description: Use when Codex needs help with producing sourced research briefs with uncertainty.
---

# Research Briefing Room Skill

## Purpose

Use this skill when Codex needs to handle producing sourced research briefs with uncertainty. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "source|citation|paper|standard|docs" docs README.md
git status --short
```
