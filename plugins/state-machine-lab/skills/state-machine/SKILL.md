---
name: state-machine
description: Use when Codex needs help with mapping states, transitions, and invalid paths.
---

# State Machine Lab Skill

## Purpose

Use this skill when Codex needs to handle mapping states, transitions, and invalid paths. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "state|status|transition|enum|switch|case"
rg "pending|active|failed|complete|cancel"
```
