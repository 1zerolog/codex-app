...
Browser QA Studio is a Codex Labkit plugin for running browser-oriented QA for local web apps and prototypes. It packages a focused workflow as a bundled skill so Codex can approach this category of work consistently.

## Why This Plugin Exists

Codex works best when broad requests are converted into clear investigation, action, and verification loops. This plugin gives Codex a repeatable path for running browser-oriented QA for local web apps and prototypes, with enough structure to be useful and enough restraint to avoid ceremony.

## Bundled Skill

- `browser-qa` - the main workflow used by this plugin.

## Good Fits

- The user asks for help with running browser-oriented QA for local web apps and prototypes.
