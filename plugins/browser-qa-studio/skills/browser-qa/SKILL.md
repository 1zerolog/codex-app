---
name: browser-qa
description: Use when Codex needs help with running browser-oriented QA for local web apps and prototypes.
---

# Browser QA Studio Skill

## Purpose

Use this skill when Codex needs to handle running browser-oriented QA for local web apps and prototypes. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
rg "className|style|css|tailwind|vite|next"
```
...
Produce a browser QA report with reproducible findings.
