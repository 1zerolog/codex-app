...
description: Use when Codex needs help with structuring incident analysis, mitigation, and follow-up.
---

# Incident Command Post Skill

## Purpose

Use this skill when Codex needs to handle structuring incident analysis, mitigation, and follow-up. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "incident|outage|rollback|deploy|error"
...
Produce a blameless incident draft.
