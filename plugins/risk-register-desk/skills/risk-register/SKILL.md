---
name: risk-register
description: Use when Codex needs help with creating risk registers for projects and changes.
---

# Risk Register Desk Skill

## Purpose

Use this skill when Codex needs to handle creating risk registers for projects and changes. The goal is to create a dependable workflow that turns a broad request into inspection, action, validation, and a concise user-facing result.
...
```bash
rg "risk|todo|fixme|deprecated|unsafe"
git diff --stat
```
