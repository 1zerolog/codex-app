---
name: log-forensics
description: Use when logs need to be reduced into a timeline, root cause hints, and next checks.
---
...
Use this skill when logs need to be reduced into a timeline, root cause hints, and next checks. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a timeline and likely cause list.
