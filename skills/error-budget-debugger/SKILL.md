---
name: error-budget-debugger
description: Use when a reliability issue needs impact, frequency, and likely cause analysis.
---

# Error Budget Debugger

## Purpose

Use this skill when a reliability issue needs impact, frequency, and likely cause analysis. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "error|timeout|retry|rate limit|fail"
rg "metrics|logging|telemetry"
```
...
Produce an operational failure summary with mitigation.
