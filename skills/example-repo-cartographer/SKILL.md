...
# Example Repo Cartographer

## Purpose

Use this skill when you need to understand a repository before making changes, especially when ownership boundaries, test commands, or file layout are unclear. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```markdown
## Example Repo Cartographer Result
