...
description: Use when reviewing code for bugs, regressions, risk, and missing tests.
---
...
Use this skill when reviewing code for bugs, regressions, risk, and missing tests. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
