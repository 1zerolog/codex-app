...
description: Use when a repository needs missing test coverage identified around changed or risky behavior.
---
...
Use this skill when a repository needs missing test coverage identified around changed or risky behavior. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a prioritized test gap list.
