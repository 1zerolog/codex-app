---
name: readme-quickstart-audit
description: Use when a README quickstart needs to be checked for accuracy and first-run success.
---

# README Quickstart Audit

## Purpose

Use this skill when a README quickstart needs to be checked for accuracy and first-run success. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
rg "install|quickstart|usage|run" README.md docs
```
...
```markdown
## README Quickstart Audit Result
...
Produce a corrected quickstart path.
