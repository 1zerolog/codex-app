---
name: third-party-api-wrapper
description: Use when wrapping an external API with a local client, adapter, or service boundary.
---
...
Use this skill when wrapping an external API with a local client, adapter, or service boundary. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```markdown
## Third Party API Wrapper Result
...
Produce a wrapper design with tests.
