---
name: risk-register
description: Use when a project or change needs a concise risk list with mitigations.
---
...
Use this skill when a project or change needs a concise risk list with mitigations. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a risk table with mitigations.
