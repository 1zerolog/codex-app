...
Use this skill when a command-line tool needs a quick install, help, and basic command verification pass. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a CLI smoke-test result and any setup gaps.
