...
description: Use when a bug fix or risky change needs targeted regression tests.
---
...
Use this skill when a bug fix or risky change needs targeted regression tests. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```markdown
## Regression Test Planner Result
...
Produce targeted regression test cases.
