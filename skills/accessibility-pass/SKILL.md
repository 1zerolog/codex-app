...
description: Use when a frontend needs accessibility checks for keyboard, labels, contrast, and semantics.
---
...
Use this skill when a frontend needs accessibility checks for keyboard, labels, contrast, and semantics. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce an accessibility risk summary with concrete fixes.
