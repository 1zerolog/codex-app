...
description: Use when workflow states, transitions, and edge cases need to be mapped.
---
...
Use this skill when workflow states, transitions, and edge cases need to be mapped. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
