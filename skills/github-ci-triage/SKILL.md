...
description: Use when GitHub Actions or status checks are failing and need structured triage.
---
...
Use this skill when GitHub Actions or status checks are failing and need structured triage. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a CI root-cause summary and fix target.
