---
name: perf-budget-review
description: Use when a feature or page needs performance budget review and obvious bottleneck checks.
---
...
Use this skill when a feature or page needs performance budget review and obvious bottleneck checks. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
rg "bundle|analyze|lighthouse" package.json
```
...
Produce performance risks and measurable fixes.
