...
description: Use when a project needs semantic versioning, compatibility, or deprecation rules.
---
...
Use this skill when a project needs semantic versioning, compatibility, or deprecation rules. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a versioning policy draft.
