...
description: Use when a large change should be split into smaller reviewable pull requests.
---
...
Use this skill when a large change should be split into smaller reviewable pull requests. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a sequence of small PR slices.
