---
name: commit-hygiene
description: Use when changes need to be staged, grouped, and described as clean reviewable commits.
---
...
Use this skill when changes need to be staged, grouped, and described as clean reviewable commits. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce reviewable commits with focused messages.
