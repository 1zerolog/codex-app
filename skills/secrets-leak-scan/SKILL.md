...
Use this skill when a repository or diff needs a quick scan for committed secrets and sensitive files. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a secrets exposure assessment.
