...
description: Use when a repeated prompt workflow should become a reusable skill, template, or plugin note.
---
...
Use this skill when a repeated prompt workflow should become a reusable skill, template, or plugin note. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a reusable skill or template draft.
