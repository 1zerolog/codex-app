...
description: Use when SQL queries need correctness, performance, and safety review.
---
...
Use this skill when SQL queries need correctness, performance, and safety review. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a SQL correctness and performance review.
