---
name: ux-copy-pass
description: Use when UI text, empty states, errors, or onboarding copy needs clarity review.
---
...
Use this skill when UI text, empty states, errors, or onboarding copy needs clarity review. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce clearer UI copy recommendations.
