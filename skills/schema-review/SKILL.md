---
name: schema-review
description: Use when JSON, database, GraphQL, or validation schemas need correctness review.
---
...
Use this skill when JSON, database, GraphQL, or validation schemas need correctness review. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a schema compatibility review.
