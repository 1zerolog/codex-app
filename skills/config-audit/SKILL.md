---
name: config-audit
description: Use when project configuration, environment variables, or defaults need review for consistency.
---
...
Use this skill when project configuration, environment variables, or defaults need review for consistency. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "process.env|os.environ|dotenv|config|settings"
...
Produce a config risk report and cleanup plan.
