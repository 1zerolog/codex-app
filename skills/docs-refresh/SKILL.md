---
name: docs-refresh
description: Use when documentation needs to be updated after behavior, API, or setup changes.
---
...
Use this skill when documentation needs to be updated after behavior, API, or setup changes. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
git diff --name-only
rg "TODO|deprecated|old|setup|install" README.md docs
```
...
Produce updated docs that match the current behavior.
