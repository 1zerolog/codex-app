...
Use this skill when TypeScript, Python typing, or schema types need a stricter safety pass. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a focused type-safety improvement plan.
