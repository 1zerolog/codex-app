---
name: issue-triage
description: Use when GitHub issues need classification, missing information, or next-action recommendations.
---
...
Use this skill when GitHub issues need classification, missing information, or next-action recommendations. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "issue|bug|feature|label" .github docs README.md
```
...
Produce labels, priority, and next action.
