...
description: Use when local development setup is broken and needs systematic diagnosis.
---
...
Use this skill when local development setup is broken and needs systematic diagnosis. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a diagnosis and local fix path.
