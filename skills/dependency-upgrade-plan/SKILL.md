...
Use this skill when package dependencies need upgrading without breaking the project. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```markdown
## Dependency Upgrade Plan Result
