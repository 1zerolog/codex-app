...
description: Use when a package is about to be released and metadata, versioning, and artifacts need review.
---
...
Use this skill when a package is about to be released and metadata, versioning, and artifacts need review. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a release checklist result.
