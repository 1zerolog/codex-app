---
name: bug-repro-lab
description: Use when a bug report needs a minimal reproduction path before fixing code.
---
...
Use this skill when a bug report needs a minimal reproduction path before fixing code. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a reproduction recipe that can fail before the fix.
