---
name: terminal-output-summarizer
description: Use when long terminal output needs a concise summary of success, failure, and next action.
---
...
Use this skill when long terminal output needs a concise summary of success, failure, and next action. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```markdown
## Terminal Output Summarizer Result
...
Produce a concise command-output summary.
