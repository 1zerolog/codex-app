...
description: Use when a monorepo needs package, workspace, ownership, and test-scope discovery.
---
...
Use this skill when a monorepo needs package, workspace, ownership, and test-scope discovery. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a monorepo package map.
