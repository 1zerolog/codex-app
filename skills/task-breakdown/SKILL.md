---
name: task-breakdown
description: Use when a broad user request needs to be split into concrete engineering tasks.
---
...
Use this skill when a broad user request needs to be split into concrete engineering tasks. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce an ordered implementation checklist.
