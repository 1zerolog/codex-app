...
description: Use when a project needs final checks before tagging, publishing, or deploying.
---
...
Use this skill when a project needs final checks before tagging, publishing, or deploying. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a release go/no-go summary.
