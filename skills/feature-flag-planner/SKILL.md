...
description: Use when a change should be rolled out behind flags, staged exposure, or kill switches.
---
...
Use this skill when a change should be rolled out behind flags, staged exposure, or kill switches. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "feature|flag|toggle|experiment|rollout"
rg "env|config|settings"
```
...
Produce a rollout and rollback plan.
