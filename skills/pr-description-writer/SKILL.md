...
description: Use when local changes need a clear pull request description.
---
...
Use this skill when local changes need a clear pull request description. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
