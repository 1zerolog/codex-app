...
description: Use when local storage, files, cache, or persistence contracts need review.
---
...
Use this skill when local storage, files, cache, or persistence contracts need review. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a persistence contract review.
