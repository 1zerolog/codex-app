...
description: Use when an OpenAPI document needs consistency, completeness, and client-generation checks.
---
...
Use this skill when an OpenAPI document needs consistency, completeness, and client-generation checks. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
rg "operationId|responses|components|security"
```
...
Produce an OpenAPI completeness report.
