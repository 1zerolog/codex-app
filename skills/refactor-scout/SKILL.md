---
name: refactor-scout
description: Use when code smells need scouting before deciding whether to refactor.
---
...
Use this skill when code smells need scouting before deciding whether to refactor. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "TODO|FIXME|copy|duplicate"
rg "if .*if|switch|case|class"
```
...
Produce a scoped refactor recommendation.
