---
name: file-cleanup-planner
description: Use when a repository has generated, obsolete, duplicate, or misplaced files to clean safely.
---

# File Cleanup Planner

## Purpose

Use this skill when a repository has generated, obsolete, duplicate, or misplaced files to clean safely. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a safe cleanup plan with explicit deletions.
