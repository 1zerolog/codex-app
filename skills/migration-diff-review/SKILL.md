...
description: Use when a migration PR needs review for data safety and compatibility.
---
...
Use this skill when a migration PR needs review for data safety and compatibility. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
git diff -- migrations db schema
rg "drop|alter|rename|delete|truncate"
```
...
Produce a migration risk review.
