...
description: Use when an outage, regression, or production issue needs a blameless postmortem draft.
---
...
Use this skill when an outage, regression, or production issue needs a blameless postmortem draft. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
```bash
rg "incident|outage|error|rollback|deploy"
...
Produce a blameless postmortem draft.
