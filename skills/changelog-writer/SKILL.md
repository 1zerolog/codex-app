...
description: Use when commits or PR changes need a concise user-facing changelog entry.
---
...
Use this skill when commits or PR changes need a concise user-facing changelog entry. It turns the request into a repeatable workflow with clear checks, outputs, and validation.
...
Produce a concise changelog entry grouped by impact.
